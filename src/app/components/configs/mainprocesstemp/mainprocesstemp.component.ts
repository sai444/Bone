...
@Component({
  selector: 'app-mainprocesstemp',
  templateUrl: './mainprocesstemp.component.html',
  styleUrls: ['./mainprocesstemp.component.scss']
})
export class MainprocesstempComponent implements OnInit {
