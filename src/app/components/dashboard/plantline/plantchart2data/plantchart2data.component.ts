...
@Component({
  selector: 'app-plantchart2data',
  templateUrl: './plantchart2data.component.html',
  styleUrls: ['./plantchart2data.component.scss']
})
export class Plantchart2dataComponent implements OnInit {
  ...
  public labelMFL2: Array<any> = [
      { data: this.lineChartData,
        label: '5 SGB 70 B IN P'
      },
      { data: this.lineChartData1,
        label: '5 SGB 40 B IN P'
      },
      { data: this.lineChartData2,
        label: 'GR.SPINDLE PRESSURE'
      },
      { data: this.lineChartData3,
        label: 'W/H SPINDLE PRESSURE'
      },
      { data: this.lineChartData4,
        label: '70 BAR FILTER STATUS '
      },
      { data: this.lineChartData5,
        label: '40 BAR PRESSURE'
      }
  ];
  ...
  ngOnInit() {
    //console.log('labelMFL2,labelMFL2', this.labelMFL2);
    setTimeout(() => {
    ...
    this.http.get<any>('http://122.166.167.113:8085/linecharttags').subscribe(data => {
      ...
      console.log('this.list =====================',this.tasklist[5].property);
    ...
    setInterval(() => {
      ...
      // this.labelMFL2.push({data: this.lineChartData, label: this.tasklist[0].property})
      ...
      // this.labelMFL2.push({data: this.lineChartData1, label: this.tasklist[1].property})
      ...
      // this.labelMFL2.push({data: this.lineChartData2, label: this.tasklist[2].property})
      ...
      // this.labelMFL2.push({data: this.lineChartData3, label: this.tasklist[3].property})
      ...
      // this.labelMFL2.push({data: this.lineChartData4, label: this.tasklist[4].property})
      ...
      // this.labelMFL2.push({data: this.lineChartData5, label: this.tasklist[5].property})
     ...
     /////////////////////////// for multiplevalues
      ...
      //   this.lineChartData = _lineChartData;
      //   this.lineChartLabels = _lineChartLabels;
      //   this.labelMFL2.push({data: this.lineChartData, label: this.tasklist[i].property});
      // }

      // //console.log("MFL", this.labelMFL2);
